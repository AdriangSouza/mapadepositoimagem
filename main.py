...
# import uvicorn  <-- Removido pois o Vercel gerencia o servidor
import pandas as pd
import os
...
# --- CORREÇÃO DE CAMINHOS PARA VERCEL ---
DIRETORIO_BASE = os.path.dirname(os.path.abspath(__file__))
CAMINHO_EXCEL = os.path.join(DIRETORIO_BASE, 'base_estoque.xlsx')
# CAMINHO_LOG = os.path.join(DIRETORIO_BASE, 'log.txt') <-- Desativado para evitar erro de permissão
...
def carregar_estoque_do_excel(nome_arquivo):
    ...
    if not os.path.exists(nome_arquivo):
        ...
        # Alterado: No Vercel apenas printamos, não escrevemos no arquivo log.txt
...
# Removido bloco if __name__ == "__main__" para o Vercel gerenciar.
